...
import org.apache.hadoop.fs.ftpextended.common.DirTree;
...
import static org.apache.hadoop.fs.ftpextended.common.AbstractFTPFileSystem.ProxyType.NONE;
import static org.apache.hadoop.fs.ftpextended.common.AbstractFTPFileSystem.ProxyType.SOCKS4;
import static org.apache.hadoop.fs.ftpextended.common.AbstractFTPFileSystem.ProxyType.SOCKS5;
...
public class FTPChannel extends AbstractChannel {
 ...
 // Client natively communicates with remote server
   ...
   * @param uri uri of the remote server to connect to
   * @return connected communication channel or null if connection can't be
   * established
   */
   ...
   * object.
   *
   * @param ftpFile info from the remote server
   * @param parentPath absolute path of the directory which contains ftpFile
   * @return file status Hadoop FileStatus describing the remote file
