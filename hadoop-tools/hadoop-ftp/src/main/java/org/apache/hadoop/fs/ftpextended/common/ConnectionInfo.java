...
import org.apache.hadoop.fs.ftpextended.common.AbstractFTPFileSystem.GlobType;
import org.apache.hadoop.fs.ftpextended.common.AbstractFTPFileSystem.ProxyType;
...
public class ConnectionInfo extends Configured {
 ...
 // Deffault keep alive in minutes
  ...
  protected static final AbstractFTPFileSystem.ProxyType DEFAULT_PROXY_TYPE
          = AbstractFTPFileSystem.ProxyType.NONE;
  protected static final AbstractFTPFileSystem.GlobType DEFAULT_GLOB_TYPE
  ...
  public ConnectionInfo(
    ...
    ftpHost = (host == null) ? conf.get(getPropertyName(FSParameter.FS_FTP_HOST,
            uriInfo), null) : host;
    Preconditions.checkNotNull(ftpHost, ErrorStrings.E_HOST_NULL);
    ...
    Preconditions.checkArgument(ftpUser != null && !ftpUser.isEmpty(),
