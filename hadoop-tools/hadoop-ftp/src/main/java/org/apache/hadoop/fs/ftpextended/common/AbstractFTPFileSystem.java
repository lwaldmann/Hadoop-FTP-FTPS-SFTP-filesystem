...
import org.apache.hadoop.fs.ftpextended.common.DirTree.INode;
...
public abstract class AbstractFTPFileSystem extends FileSystem {
 ...
 // or reimplement if we ever decide to support setWorkingDirectory
   ...
   * @throws java.io.IOException communication problem
   */
   ...
   * @throws java.io.IOException communication problem or dir is not a directory
   */
  ...
  public FileStatus[] globStatus(Path pathPattern) throws IOException {
    ...
    Path qualifiedPattern
            = pathPattern.makeQualified(uri, getWorkingDirectory());
