 ...
 */
package org.apache.hadoop.fs.ftpextended.contract.ftp;
...
public class ITestContractSeek extends AbstractContractSeekTest implements
  ...
  public static Collection<Object[]> data() {
    Object[][] data = {{true, "ftp"}, {true, "ftps"},
        {false, "ftp"}, {false, "ftps"}};
